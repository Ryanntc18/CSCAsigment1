...
namespace Task2.Controllers
{
    public class ProductController : ApiController
    {
        ...
        [HttpPost]
        [Route("api/v3/products")]
        public HttpResponseMessage PostProduct(ProductDTO item1)
        {
        ...
        public HttpResponseMessage DeleteProduct(int id)
        {
            ...
            string text = "Product " + name + " has been deleted";
            var response = Request.CreateResponse<string>(HttpStatusCode.Created, text);
            return response;
        }
    }
}